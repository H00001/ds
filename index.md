...
<img src="./assets/wps5-1949155.png" alt="img" style="zoom:50%;" /> 
...
22. 当在一个有序的顺序存储表上查找一个数据时，即可用折半查找，也可用顺序查找，但前 者比后者的查找速度(   )。
A. 必定快                              B.不一定
C.  在大部分情况下要快              D. 取决于表递增还是递减
23. 请指出在顺序有序表(2、5、7、10、14、15、18、23、35、41、52)中，用“折半查找法” 查找关键字14需做的比较次数为(   )。
A.2                          B.3                                  C.4                                  D.5
24. 折半查找有序表(5,8,10,22,36,50,53,88),若查找元素70,则需依次与表中元素(关键 字 ) (   )进行比较，查找结果是“失败”。、
